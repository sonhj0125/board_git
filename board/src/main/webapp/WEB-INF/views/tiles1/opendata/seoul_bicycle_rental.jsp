...
//				console.log(JSON.stringify(json));
		...
		// infowindowArr 은 인포윈도우를 가지고 있는 객체 배열의 용도이다. 
     	...
     	// === 객체 배열만큼 마커 및 인포윈도우를 생성하여 지도 위에 표시한다. === //
     	for(var i=0; i<positionArr.length; i++) {
     		
     		// == 마커 생성하기 == //
     		var marker = new kakao.maps.Marker({ 
				map: mapobj, 
			    position: positionArr[i].latlng // positionArr 배열 안에 있는 position.latlng 좌표에 마커를 생성 
			});
            ...
            // == 마커 위에 인포윈도우를 표시하기 == //
//			infowindow.open(mapobj, marker); // ==> 잘못된 방법!
