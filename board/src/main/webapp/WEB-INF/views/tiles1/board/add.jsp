...
$(document).ready(function() {
	...
	$("button#btnWrite").click(function() {
		...
		if(subject == "") {
			alert("글제목을 입력하세요!");
			$("input:text[name='subject']").val(""); // 공백 없애기
			return; // 종료
		}
...
//		alert(content_val); // content에 공백만 여러 개 입력하여 작성할 경우 알아보기
		// 결과 : <p>&nbsp; &nbsp; &nbsp;&nbsp;</p>
...
<div style="display: flex;">
   ...
   <%-- <c:if test='${requestScope.fk_seq ne ""}'> --%>
		...
		<%-- <form name="addFrm"> --%>
		<%-- === #169. 파일 첨부하기 ===
			  먼저, 위의 <form name="addFrm"> 을 주석 처리한 후에 아래와 같이 해야 한다.
			 enctype="multipart/form-data" 을 해주어야만 파일 첨부가 가능하다.
		--%>
