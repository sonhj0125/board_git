...
$(document).ready(function() {
   ...
   $("div#mycontent").css({"background-color":"#cce0ff"});
    ...
    const url = window.location.host; // 웹브라우저 주소창의 포트까지 가져옴
//  alert("url : " + url);
    // url : 192.168.0.202:9099
    
    const pathname = window.location.pathname; // 최초의 '/'로부터 오른쪽에 있는 모든 경로
...
//   alert("appCtx : " + appCtx);
   ...
   // 즉, const websocket = new WebSocket("ws://192.168.0.202:9099/board/chatting/multichatstart.action"); 이다.
    ...
    */
    ...
    // === 웹소켓에 최초로 연결이 되었을 경우에 실행되는 콜백함수 정의하기 === //
    websocket.onopen = function() {
//      alert("웹소켓 연결됨!");
      
       $("div#chatStatus").text("정보: 웹소켓에 연결 성공!!");
