...
public class MemberVO {
    ...
    private int pwdchangegap;          // select 용. 지금으로부터 마지막으로 암호를 변경한지가 몇개월인지 알려주는 개월수
    								   //			(3개월 동안 암호를 변경하지 않았을 시 암호를 변경하라는 메시지를 보여주기 위함)
    
    private int lastlogingap;		   // select 용. 지금으로 부터 마지막으로 로그인한지가 몇개월인지 알려주는 개월수
    								   // 			(12개월 동안 로그인을 하지 않았을 경우 해당 로그인 계정을 비활성화 시키려고 함)
